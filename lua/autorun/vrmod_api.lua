...
if CLIENT then
	...
	local function GetFingerAnglesFromModel( modelName, sequenceNumber )
		...
		local pm = g_VR.convars.floatingHands:GetBool() and "models/weapons/c_arms.mdl" or LocalPlayer():GetModel()
	...
	function vrmod.StartLocomotion()
		local selectedOption = g_VR.locomotionOptions[GetConVar("vrmod_locomotion"):GetInt()]
