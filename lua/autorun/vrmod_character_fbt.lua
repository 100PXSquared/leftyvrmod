if SERVER then
	...
	net.Receive( "vrmod_fbt_toggle", function( len, ply )
...
local function Init( ply )
	...
	if info.modelName == ply:GetModel() then return end
	info.modelName = ply:GetModel()
	
	local tmpPlayerModel = ClientsideModel(info.modelName)
